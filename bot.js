...
client.on('message', async msg => { // eslint-disable-line
	...
	if (command === `play`) {
		if (msg.member.voiceChannelID !== "483035269440995338") return msg.reply(`You should be in \`\`${client.channels.get("483035198150148097").name}\`\` to use me`);	
